...
* The generate documentation / review and update / execute documentation workflow works well and minimizes surprises.  You also have up-to-date documentation for what you built.   
